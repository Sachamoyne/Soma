...
- Couvrir TOUS les concepts importants du texte`,
  ...
  generateFromAnalysis: (conceptsList: string, cardCountInstruction: string, detailInstruction: string) => `Tu es un expert en création de flashcards pour la mémorisation efficace.
...
FORMAT DE SORTIE :
{
  ...
  fallback: (cardCountInstruction: string, detailInstruction: string, retryCorrection: string) => `Tu es un expert en création de flashcards pour la mémorisation efficace et l'apprentissage conceptuel.
