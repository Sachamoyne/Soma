...
exports.PREPA_MATHS_PROMPTS = void 0;
exports.PREPA_MATHS_PROMPTS = {
    // ============================================================================
...
- Séparer clairement : définitions, hypothèses, conclusions`,
    ...
    // ============================================================================
    generateFromAnalysis: (conceptsList, cardCountInstruction, detailInstruction) => `Tu es un expert en création de flashcards mathématiques pour classes préparatoires (CPGE).
...
- Tags techniques de type "Définition", "Théorème", etc. (garder uniquement les concept_id)`,
    ...
    // ============================================================================
    fallback: (cardCountInstruction, detailInstruction, retryCorrection) => `Tu es un expert en création de flashcards mathématiques pour classes préparatoires (CPGE).
...
//# sourceMappingURL=prepa-maths.js.map